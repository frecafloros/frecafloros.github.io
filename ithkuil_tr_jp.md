...
|||||||||||||  
|--|--|--|--|--|--|--|--|--|--|--|--|  
|1格<br>斜格|a|2格<br>帰納格|u|3格<br>絶対格|e|4格<br>能格|5格<br>実行格|ö|6格<br>影響格|i|  
...
|19格|ia<br>ua|20格|ie<br>ue|21格|io<br>uo|22格||23格||24格||  
|25格||26格||27格||28格||29格||30格||  
|31格||32格||33格||34格||||||  
|||||||||||||  
|||||||||||||  
|||||||||||||  
...
### 4.3.1 斜格？:1格(oblique)
対格？**a**で表される。日本語では主に**～を**にあたる。誰かが受け取ったものや、抽象度が高く因果関係の無い内容を表す。よくわからない。  
「私に**本を**渡した」  
「**穀物を**好む」  
