...
例えば、タイプ1接尾辞**-up** (**-V1p/9**)とタイプ2接尾辞**-uip** (**V2p/9**)はどちらも「確定的に似ている/完全に同一の」を意味するが、これらの使い方の違いは、タイプ1接尾辞が状況的、偶発的な類似性を伝えるのに対し、タイプ2接尾辞は類似性が単語の不可欠な側面であることを暗示している。英語では、このような区別は大体において別の単語を使用することで伝えられる。例えば、イスクイル語の **eqal** 「人」にこの二つの接尾辞を加えた場合の違いに注目すると、**eqalup**は「同じに見える人」、**eqaluip**は「双子」を意味する。つまり、**-Vp**のタイプ1接尾辞は、その意味を状況証拠的に語幹に適用することを意味し、タイプ2接尾辞は、その意味を派生的に適用することを意味する。つまり、全く新しい概念や単語が語幹から派生する。  
